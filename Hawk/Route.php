...
class Route extends Routable implements RouteInterface
{
    ...
    /**
     * Flags that this route should be authenticated
     *
     * @var boolean
     */
    ...
    /**
     * Flags that this route shouldn't be authenticated
     *
     * @var boolean
     */
    ...
    /**
     * True if this route must be authenticated
     *
     * @var boolean
     */
    protected $authenticated = self::UNAUTHENTICATED;
     ...
     */
    public function __construct($methods, $pattern, $callable, $authenticated, $params, $groups = [], $identifier = 0)
    {
    ...
    /**
     * Set route's authenticated boolean
     *
     * @param boolean $authenticated
     *
     * @return self
     *
     * @throws InvalidArgumentException if the route name is not a boolean
     */
    public function setAuthenticated($authenticated)
    {
        if (!is_bool($authenticated)) {
            throw new InvalidArgumentException('Route authenticated must be a boolean');
        }
        $this->authenticated = $authenticated;
        return $this;
    }
